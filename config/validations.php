...
use App\Rules\ExistsWithSoftDeletedRule;
...
return [
    ...
    'unique' => 'unique:%s,%s',
    'email' => [
        'req' => 'required|string|email|min:3|max:250',
        'null' => 'nullable|string|email|min:3|max:250',
    ],
    'boolean' => [
